...
// BindHeader
func BindHeader(ctx *kgin.TContext) *KuaigoHeader {
...
// getRt
//  @Description  获取客户端发起请求时客户端时间(request time)
//  @Param ctx
//  @Return int64
...
// SetTi
//  @Description  设置请求跟踪标识(trace id)
//  @Param i
//  @Param header
func SetTi(i int, header *KuaigoHeader) {
	if i > 0 && header.TI != "" {
...
//  @Param ctx
//  @Param header
func SetHeader(ctx *kgin.TContext, header *KuaigoHeader) {
	ctx.Set(constant.KeyHeader, header)
}

// SetAdminHeader
//  @Description  设置adminheader
//  @Param ctx
//  @Param adminHeader
...
//  @Param ctx
//  @Param claims
func SetCurrUser(ctx *kgin.TContext, claims *kjwt.MyClaims) {
