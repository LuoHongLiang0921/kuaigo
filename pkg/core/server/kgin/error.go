...
var (
	...
	errMicroResInvalid    = status.Errorf(codes.Internal, createStatusErr(codeMSResErr, "xresponse is not valid"))
)
...
var (
	...
	ErrGRPCResponseValid = grpc.Errorf(codes.Internal, "xresponse valid")
	// ErrGRPCInvokeLen ...
