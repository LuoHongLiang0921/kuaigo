...
const (
	...
	// CodeRateLimitError 访问受限
	CodeRateLimitError = 4035
...
func (c *ECode) LoadCreateCodeMsg(ctx context.Context, appId int, code int, msg string, lang string, name string, serviceId int) {
	...
	codeResp := &statusCodeResp{}
	resp,err := khttp.PostJson(ctx, c.StatusCodeCreateUrl, req)
	if err != nil {
		klog.WithContext(ctx).Errorf("LoadCreateCodeMsg err:%v", err)
		return
	}
	resp.Json(codeResp)
	...
	c.CodeMsgMapper[codeResp.Data.Code] = codeResp.Data.Msg
}
...
func (c *ECode) LoadUpdateCodeMsg(ctx context.Context, appId int, code int, msg string, lang string, name string, serviceId int) {
	...
	codeResp := &statusCodeResp{}
	resp,err := khttp.PostJson(ctx, c.StatusCodeUpdateUrl, req)
	if err != nil {
...
func (c *ECode) LoadCodeMsg(ctx context.Context, code int) {
	...
	codeResp := &statusCodeResp{}
	resp,err := khttp.PostJson(ctx, c.StatusCodeURL, req)
	if err != nil {
		klog.Errorf("", klog.FieldCommon(nil), klog.FieldParams(map[string]interface{}{
			"msg": "LoadCodeMsg",
		}), klog.String("type", "bizLog"))
...
func (c *ECode) LoadCodeListMsg(ctx context.Context, serviceID int) {
	...
	var codeResp statusCodeListResp
	resp,err := khttp.PostJson(ctx, c.StatusCodeListUrl, req)
	if err != nil {
		klog.Errorf("", klog.FieldCommon(nil), klog.FieldParams(map[string]interface{}{
			"msg": "LoadCodeMsg",
		}), klog.String("type", "bizLog"))
