...
const (
	// TagName is the copy struct tag name.
	TagName = "copy"
...
func CopyStruct(src interface{},dst interface{}) interface{} {
	Copy(src).To(dst)
	return &dst
}
// Copy
...
//  @Param src
//  @Return *Xstruct
func Copy(src interface{}) *Xstruct {
	return &Xstruct{src: src}
}

// WithContext
//  @Description: 将instance1深度复制到instance2中，并传递以下上下文
//  @Receiver dc
//  @Param ctx
//  @Return *Xstruct
func (dc *Xstruct) WithContext(ctx map[string]interface{}) *Xstruct {
	dc.ctx = ctx
	return dc
}

// To
//  @Description: 设置目标instance
//  @Receiver dc
//  @Param dst
//  @Return error
func (dc *Xstruct) To(dst interface{}) error {
	dc.dst = dst
...
//  @Param src
//  @Return error
func (dc *Xstruct) From(src interface{}) error {
	dc.dst = dc.src
	dc.src = src
