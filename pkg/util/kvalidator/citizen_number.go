...
// IsCitizenNo18 效验18位身份证
// 	@Description 效验18位身份证
//	@Param citizenNo18
// 	@Return bool
func IsCitizenNo18(citizenNo18 *[]byte) bool {
...
// IsBirthday
// 	@Description 生日日期格式效验
//	@Param nYear
//	@Param nMonth
//	@Param nDay
// 	@Return bool
func IsBirthday(nYear, nMonth, nDay int) bool {
...
// IsCitizenNo
// 	@Description 效验有效地身份证号码
//	@Param citizenNo
// 	@Return bool
func IsCitizenNo(citizenNo *[]byte) bool {
	if !IsCitizenNo18(citizenNo) {
		return false
	}
	...
	if !IsBirthday(nYear, nMonth, nDay) {
		return false
	}
	return true
}
...
// GetCitizenNoInfo
// 	@Description 得到身份证号码，生日, 性别, 省份地址信息
//	@Param citizenNo
// 	@Return err
// 	@Return birthday
// 	@Return sex
...
func GetCitizenNoInfo(citizenNo []byte) (err error, birthday time.Time, sex string, address string) {
	...
	address = validProvince[string(citizenNo[:2])]
	return
}
